...
const Sidebar = () => {
  return (
    <div className="flex justify-between items-center flex-col sticky ml-[50px]">
      <div className="flex justify-between items-center">
        ...
        <p className="font-bold ml-[5px] text-[25px]">Crowdfunding</p>
      </div>
      <div className="flex-1 flex flex-col justify-between items-center bg-base-200 mt-[20px] rounded-[20px] w-[250px]">
          ...
          <ul className="menu menu-vertical bg-base-200 rounded-box">
            <li>
              <Link to="/">
                ...
                <span className="ml-[20px] font-bold text-[15px]">Home</span>
              </Link>
            </li>
            <li>
              <Link to="/dashboard">
                ...
                <span className="ml-[20px] font-bold text-[15px]">
                  Dashboard
                </span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/ranking">
                ...
                <span className="ml-[20px] font-bold text-[15px]">Ranking</span>
              </Link>
            </li>
            <li>
              <Link to="/withdraw">
            ...
            <li>
              <Link to="/profile">
                ...
                <span className="ml-[20px] font-bold text-[15px]">Profile</span>
              </Link>
            </li>
            <li>
              <a>
                ...
                <span className="ml-[20px] font-bold text-[15px]">Logout</span>
              </a>
            </li>
          </ul>
        </div>
